                    ...
                    ->each(function ($inspection) use (&$rows) {
                        $rows[] =
                            [
                                ...
                                "intervention_date" => $inspection["last_inspection_date"],
                            ];
                    });
                return $rows;
            case 'carAssignment':
                    ...
                    ->each(function ($carAssignment) use (&$rows) {
                        $rows[] =
                            [
                                ...
                                "Date" => $carAssignment->toArray()["Date"],
                                "quantity" => $carAssignment->toArray()["quantity"],
                                "montant" => $carAssignment->toArray()["montant"],
                                "provider" => $carAssignment->toArray()["provider"],
                            ];
                    });
                return $rows;
